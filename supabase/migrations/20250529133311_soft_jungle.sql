/*
  # Enable Basic Login Functionality
  
  1. Changes
    - Drop all existing policies
    - Create simple policies that allow all authenticated users to read data
    - Maintain user-specific write access for personal data
    
  2. Security
    - All authenticated users can view all classes, modules, and resources
    - Users can only manage their own notes, progress, and enrollments
*/
